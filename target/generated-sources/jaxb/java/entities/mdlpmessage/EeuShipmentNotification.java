 ...
 *         &lt;/element&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="action_id" use="required" type="{http://www.w3.org/2001/XMLSchema}int" fixed="615" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "eeu_shipment_notification", propOrder = {
    "subjectId",
    "sellerId",
    "receiverId",
    "operationDate",
...
public class EeuShipmentNotification {
    ...
    protected EeuShipmentNotification.OrderDetails orderDetails;
     ...
     * @return
     *     possible object is
     *     {@link EeuShipmentNotification.OrderDetails }
     *     
     */
    public EeuShipmentNotification.OrderDetails getOrderDetails() {
        return orderDetails;
    }
     ...
     *     
     */
    public void setOrderDetails(EeuShipmentNotification.OrderDetails value) {
    ...
    public static class OrderDetails {
        ...
        protected List<EeuShipmentNotification.OrderDetails.Union> union;
         ...
         * {@link EeuShipmentNotification.OrderDetails.Union }
         * 
         * 
         */
        public List<EeuShipmentNotification.OrderDetails.Union> getUnion() {
            if (union == null) {
                union = new ArrayList<EeuShipmentNotification.OrderDetails.Union>();
            }
            return this.union;
        }
        ...
        public static class Union {
            ...
            protected EeuShipmentNotification.OrderDetails.Union.SsccDetail ssccDetail;
            @XmlElement(required = true)
             ...
             * @return
             *     possible object is
             *     {@link EeuShipmentNotification.OrderDetails.Union.SsccDetail }
             *     
             */
            public EeuShipmentNotification.OrderDetails.Union.SsccDetail getSsccDetail() {
                return ssccDetail;
            }
             ...
             *     
             */
            public void setSsccDetail(EeuShipmentNotification.OrderDetails.Union.SsccDetail value) {
            ...
            public static class SsccDetail {
                ...
                protected List<EeuShipmentNotification.OrderDetails.Union.SsccDetail.Detail> detail;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link EeuShipmentNotification.OrderDetails.Union.SsccDetail.Detail }
                 * 
                 * 
                 */
                public List<EeuShipmentNotification.OrderDetails.Union.SsccDetail.Detail> getDetail() {
                    if (detail == null) {
                        detail = new ArrayList<EeuShipmentNotification.OrderDetails.Union.SsccDetail.Detail>();
                    }
                    return this.detail;
                }
