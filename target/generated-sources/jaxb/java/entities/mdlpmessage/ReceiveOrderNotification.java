 ...
 * 
 * <p>Java class for receive_order_notification complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="receive_order_notification"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;/element&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="action_id" use="required" type="{http://www.w3.org/2001/XMLSchema}int" fixed="602" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "receive_order_notification", propOrder = {
    "subjectId",
    "shipperId",
    "operationDate",
    "docNum",
...
public class ReceiveOrderNotification {
    ...
    protected ReceiveOrderNotification.OrderDetails orderDetails;
     ...
     * @return
     *     possible object is
     *     {@link ReceiveOrderNotification.OrderDetails }
     *     
     */
    public ReceiveOrderNotification.OrderDetails getOrderDetails() {
        return orderDetails;
    }
     ...
     *     
     */
    public void setOrderDetails(ReceiveOrderNotification.OrderDetails value) {
    ...
    public static class OrderDetails {
        ...
        protected List<ReceiveOrderNotification.OrderDetails.Union> union;
         ...
         * {@link ReceiveOrderNotification.OrderDetails.Union }
         * 
         * 
         */
        public List<ReceiveOrderNotification.OrderDetails.Union> getUnion() {
            if (union == null) {
                union = new ArrayList<ReceiveOrderNotification.OrderDetails.Union>();
            }
            return this.union;
        }
        ...
        public static class Union {
            ...
            protected ReceiveOrderNotification.OrderDetails.Union.SsccDetail ssccDetail;
            @XmlElement(required = true)
             ...
             * @return
             *     possible object is
             *     {@link ReceiveOrderNotification.OrderDetails.Union.SsccDetail }
             *     
             */
            public ReceiveOrderNotification.OrderDetails.Union.SsccDetail getSsccDetail() {
                return ssccDetail;
            }
             ...
             *     
             */
            public void setSsccDetail(ReceiveOrderNotification.OrderDetails.Union.SsccDetail value) {
            ...
            public static class SsccDetail {
                ...
                protected List<ReceiveOrderNotification.OrderDetails.Union.SsccDetail.Detail> detail;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link ReceiveOrderNotification.OrderDetails.Union.SsccDetail.Detail }
                 * 
                 * 
                 */
                public List<ReceiveOrderNotification.OrderDetails.Union.SsccDetail.Detail> getDetail() {
                    if (detail == null) {
                        detail = new ArrayList<ReceiveOrderNotification.OrderDetails.Union.SsccDetail.Detail>();
                    }
                    return this.detail;
                }
