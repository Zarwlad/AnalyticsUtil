 ...
 * 
 * <p>Java class for eeu_import complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="eeu_import"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;/element&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="action_id" use="required" type="{http://www.w3.org/2001/XMLSchema}int" fixed="362" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "eeu_import", propOrder = {
    "subjectId",
    "sellerId",
    "operationDate",
    "shipperId",
...
public class EeuImport {
    ...
    protected EeuImport.OrderDetails orderDetails;
     ...
     * @return
     *     possible object is
     *     {@link EeuImport.OrderDetails }
     *     
     */
    public EeuImport.OrderDetails getOrderDetails() {
        return orderDetails;
    }
     ...
     *     
     */
    public void setOrderDetails(EeuImport.OrderDetails value) {
    ...
    public static class OrderDetails {
        ...
        protected List<EeuImport.OrderDetails.Union> union;
         ...
         * {@link EeuImport.OrderDetails.Union }
         * 
         * 
         */
        public List<EeuImport.OrderDetails.Union> getUnion() {
            if (union == null) {
                union = new ArrayList<EeuImport.OrderDetails.Union>();
            }
            return this.union;
        }
        ...
        public static class Union {
            ...
            protected EeuImport.OrderDetails.Union.SsccDetail ssccDetail;
            @XmlElement(required = true)
             ...
             * @return
             *     possible object is
             *     {@link EeuImport.OrderDetails.Union.SsccDetail }
             *     
             */
            public EeuImport.OrderDetails.Union.SsccDetail getSsccDetail() {
                return ssccDetail;
            }
             ...
             *     
             */
            public void setSsccDetail(EeuImport.OrderDetails.Union.SsccDetail value) {
            ...
            public static class SsccDetail {
                ...
                protected List<EeuImport.OrderDetails.Union.SsccDetail.Detail> detail;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link EeuImport.OrderDetails.Union.SsccDetail.Detail }
                 * 
                 * 
                 */
                public List<EeuImport.OrderDetails.Union.SsccDetail.Detail> getDetail() {
                    if (detail == null) {
                        detail = new ArrayList<EeuImport.OrderDetails.Union.SsccDetail.Detail>();
                    }
                    return this.detail;
                }
