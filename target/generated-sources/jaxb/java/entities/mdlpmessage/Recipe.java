 ...
 *         &lt;/element&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="action_id" use="required" type="{http://www.w3.org/2001/XMLSchema}int" fixed="521" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class Recipe {
    ...
    protected Recipe.OrderDetails orderDetails;
     ...
     * @return
     *     possible object is
     *     {@link Recipe.OrderDetails }
     *     
     */
    public Recipe.OrderDetails getOrderDetails() {
        return orderDetails;
    }
     ...
     *     
     */
    public void setOrderDetails(Recipe.OrderDetails value) {
    ...
    public static class OrderDetails {
        ...
        protected List<Recipe.OrderDetails.Union> union;
         ...
         * {@link Recipe.OrderDetails.Union }
         * 
         * 
         */
        public List<Recipe.OrderDetails.Union> getUnion() {
            if (union == null) {
                union = new ArrayList<Recipe.OrderDetails.Union>();
            }
            return this.union;
        }
