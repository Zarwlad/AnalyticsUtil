 ...
 * 
 * <p>Java class for move_order_notification complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="move_order_notification"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="turnover_type" type="{}turnover_type_enum"/&gt;
 ...
 *         &lt;/element&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="action_id" use="required" type="{http://www.w3.org/2001/XMLSchema}int" fixed="601" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "move_order_notification", propOrder = {
    "subjectId",
    "receiverId",
    "operationDate",
    "docNum",
...
public class MoveOrderNotification {
    ...
    @XmlElement(name = "turnover_type")
    protected int turnoverType;
    ...
    protected MoveOrderNotification.OrderDetails orderDetails;
     ...
     * 
     */
    public void setTurnoverType(int value) {
     ...
     * @return
     *     possible object is
     *     {@link MoveOrderNotification.OrderDetails }
     *     
     */
    public MoveOrderNotification.OrderDetails getOrderDetails() {
        return orderDetails;
    }
     ...
     *     
     */
    public void setOrderDetails(MoveOrderNotification.OrderDetails value) {
    ...
    public static class OrderDetails {
        ...
        protected List<MoveOrderNotification.OrderDetails.Union> union;
         ...
         * {@link MoveOrderNotification.OrderDetails.Union }
         * 
         * 
         */
        public List<MoveOrderNotification.OrderDetails.Union> getUnion() {
            if (union == null) {
                union = new ArrayList<MoveOrderNotification.OrderDetails.Union>();
            }
            return this.union;
        }
        ...
        public static class Union {
            ...
            protected MoveOrderNotification.OrderDetails.Union.SsccDetail ssccDetail;
            @XmlElement(required = true)
             ...
             * @return
             *     possible object is
             *     {@link MoveOrderNotification.OrderDetails.Union.SsccDetail }
             *     
             */
            public MoveOrderNotification.OrderDetails.Union.SsccDetail getSsccDetail() {
                return ssccDetail;
            }
             ...
             *     
             */
            public void setSsccDetail(MoveOrderNotification.OrderDetails.Union.SsccDetail value) {
            ...
            public static class SsccDetail {
                ...
                protected List<MoveOrderNotification.OrderDetails.Union.SsccDetail.Detail> detail;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link MoveOrderNotification.OrderDetails.Union.SsccDetail.Detail }
                 * 
                 * 
                 */
                public List<MoveOrderNotification.OrderDetails.Union.SsccDetail.Detail> getDetail() {
                    if (detail == null) {
                        detail = new ArrayList<MoveOrderNotification.OrderDetails.Union.SsccDetail.Detail>();
                    }
                    return this.detail;
                }
