 ...
 * 
 * <p>Java class for move_order complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="move_order"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;/element&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="action_id" use="required" type="{http://www.w3.org/2001/XMLSchema}int" fixed="415" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "move_order", propOrder = {
    "subjectId",
    "receiverId",
    "operationDate",
    "docNum",
...
public class MoveOrder {
    ...
    protected MoveOrder.OrderDetails orderDetails;
     ...
     * @return
     *     possible object is
     *     {@link MoveOrder.OrderDetails }
     *     
     */
    public MoveOrder.OrderDetails getOrderDetails() {
        return orderDetails;
    }
     ...
     *     
     */
    public void setOrderDetails(MoveOrder.OrderDetails value) {
    ...
    public static class OrderDetails {
        ...
        protected List<MoveOrder.OrderDetails.Union> union;
         ...
         * {@link MoveOrder.OrderDetails.Union }
         * 
         * 
         */
        public List<MoveOrder.OrderDetails.Union> getUnion() {
            if (union == null) {
                union = new ArrayList<MoveOrder.OrderDetails.Union>();
            }
            return this.union;
        }
        ...
        public static class Union {
            ...
            protected MoveOrder.OrderDetails.Union.SsccDetail ssccDetail;
            @XmlElement(required = true)
             ...
             * @return
             *     possible object is
             *     {@link MoveOrder.OrderDetails.Union.SsccDetail }
             *     
             */
            public MoveOrder.OrderDetails.Union.SsccDetail getSsccDetail() {
                return ssccDetail;
            }
             ...
             *     
             */
            public void setSsccDetail(MoveOrder.OrderDetails.Union.SsccDetail value) {
            ...
            public static class SsccDetail {
                ...
                protected List<MoveOrder.OrderDetails.Union.SsccDetail.Detail> detail;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link MoveOrder.OrderDetails.Union.SsccDetail.Detail }
                 * 
                 * 
                 */
                public List<MoveOrder.OrderDetails.Union.SsccDetail.Detail> getDetail() {
                    if (detail == null) {
                        detail = new ArrayList<MoveOrder.OrderDetails.Union.SsccDetail.Detail>();
                    }
                    return this.detail;
                }
